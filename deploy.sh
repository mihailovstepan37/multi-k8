...
docker push -t stephengrider/multi-client:latest
docker push -t stephengrider/multi-server:latest
docker push -t stephengrider/multi-worker:latest

docker push -t stephengrider/multi-client:$SHA
docker push -t stephengrider/multi-server:$SHA
docker push -t stephengrider/multi-worker:$SHA
